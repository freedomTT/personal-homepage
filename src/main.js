...
appClass.prototype = {
    ...
    *  */
    ...
    initDNAScense() {
        ...
        this.dnaScene.add(this.pLight);

        let pLight2 = new THREE.PointLight('#0d65ff', 1, 0, 2);
    ...
    initTimeLine: function () {
        ...
        $(document).bind('mousemove', (event) => {
                ...
                vec.set(
                    ...
                    0.5);
                vec.unproject(this.dnaCamera);
                vec.sub(this.dnaCamera.position).normalize();
                // let distance = -this.dnaCamera.position.z / vec.z;
                let distance = (this.pLight.position.z - this.dnaCamera.position.z) / vec.z;
                pos.copy(this.dnaCamera.position).add(vec.multiplyScalar(distance));
                console.log(pos)
